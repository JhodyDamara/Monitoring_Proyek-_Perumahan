                ...
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('mandor/data_proyek/pembangunan/pengeluaran_keuangan/tambah_pengeluaran_keuangan')?>"  class="more-39291">Tambah Pengeluaran Keuangan</a></p>
                        </div>
                    </div>
                    <div class="row">
