                        ...
                        <div class="col-md-12" data-aos="fade-up" data-aos-delay="">
                            <div class="media-92812">
                                <table class="proyek">
                                    ...
                                    <?php 
                                        if(empty($data_proyek_status)) echo "<td colspan='5'>Belum memiliki pembangunan proyek</td>";
                                        foreach ($data_proyek_status as $key => $value){
                                            ...
                                            echo "<td><a href='".site_url('mandor/data_pembangunan_proyek/lihat_data_pembangunan/'.$value["id_data_proyek"])."'>Lihat</a></td>";
                                            echo "</tr>";
                                        }
                                    ?> 
                                </table>
