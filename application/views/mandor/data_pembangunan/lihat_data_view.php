                        ...
                        <?php
                            ...
                            foreach ($lihat_data_pembangunan['blok'] as $key => $value){
                                ...
                                foreach ($lihat_data_pembangunan['unit'][$key] as $key1 => $value1) {
                                    ...
                                    echo "<p><a href='".site_url('mandor/data_pembangunan_proyek/lihat_data_pembangunan/tambah_perkembangan_proyek/'.$key1)."' class='more-39291'>Tambah Perkembangan Proyek</a></p>";
                                    ...
                                    foreach ($lihat_data_pembangunan['pekerjaan'][$key1] as $value2) {
                                        ...
                                        $link=site_url('mandor/data_pembangunan_proyek/lihat_data_pembangunan/edit_target_pekerjaan/'.$value2['id_target_pembangunan']);
                                        if($lihat_data_pembangunan['perkembangan'][$value2['id_target_pembangunan']]==0) $link="javascript:void(0)";
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='3'>Total Persentase $value1</td>";
                                    echo "<td colspan='2' align='center'>".number_format($total_persentasi,1)." %</td>";
                                    echo "</tr>";
                                    echo "</table><br>";
                                    echo "<h4>Rancangan Anggaran</h4>";
                                    echo "<p><a href='".site_url('mandor/data_pembangunan_proyek/lihat_data_pembangunan/tambah_pengeluaran_proyek/'.$key1)."' class='more-39291'>Tambah Pengeluaran Proyek</a></p>";
                                    echo "<table class='proyek'>";
                                    echo "<tr>";
                                    echo "<th>No</th>";
