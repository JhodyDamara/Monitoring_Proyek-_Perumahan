        ...
        <div class="site-wrap" id="home-section">
            ...
            <div class="site-section">
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            <h1 class="heading-39291">Pengaturan Admin</h1>
                            <p><?php $this->load->view("_partials/breadcrumb.php") ?></p>
                            <p class="my-5"><a href="<?=site_url('admin/pengaturan/tambah_akun')?>" class="more-39291">Tambah Akun</a></p>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <table class="proyek">
                                    ...
                                    <?php
                                        ...
                                        foreach ($tampil as $tampil): 
                                            ...
                                            echo "<td>".$tampil->jenis_pengguna."</td>";
                                            echo "<td><img alt='' src='".base_url('images/pengguna/'.$tampil->foto)."' width='100px'></td>";
                                            ?>
                                                <td>
                                                    <a href="<?=site_url('admin/pengaturan/edit_akun/'.$tampil->username)?>">Edit</a>
                                                    / 
                                                    <a href="#!" onclick="deletekonfirm('<?=site_url('admin/pengaturan/hapus_akun/'.$tampil->username)?>')">Hapus</a>
                                                </td>
                                            <?php
                                            echo "</tr>";
                                            $i++;
