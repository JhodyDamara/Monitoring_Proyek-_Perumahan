                ...
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('admin/data_proyek/perancangan/anggaran/tambah_anggaran')?>" class="more-39291">Tambah Anggaran</a></p>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        foreach ($tampil as $tampil):
                                            ?>
                                                <tr> 
                                                    ...
                                                    <td>
                                                        <a href="<?=site_url('admin/data_proyek/perancangan/anggaran/edit_anggaran/'.$tampil->id_target_keuangan)?>">Edit</a>
                                                        / 
                                                        <a href="#!" onclick="deletekonfirm('<?=site_url('admin/data_proyek/perancangan/anggaran/hapus_anggaran/'.$tampil->id_target_keuangan)?>')">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            $no++;
