                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <p><a href="<?=site_url('admin/data_proyek/perancangan/pembangunan')?>" class="more-39291">Pembangunan</a></p>
                            <p><a href="<?=site_url('admin/data_proyek/perancangan/anggaran')?>" class="more-39291">Anggaran</a></p>
                            <p><a href="<?=site_url('admin/data_proyek/perancangan/start/'.$lama.'/'.$biaya)?>" class="more-39291">Start Project</a></p>
                        </div>
