                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <p><a href="<?=site_url('admin/data_proyek/pembangunan/perkembangan_pembangunan')?>" class="more-39291">Perkembangan Pembangunan</a></p>
                            <p><a href="<?=site_url('admin/data_proyek/pembangunan/pengeluaran_keuangan')?>" class="more-39291">Pengeluaran Keuangan</a></p>
                            <p><a href="<?=site_url('admin/data_proyek/pembangunan/evaluasi')?>" class="more-39291">evaluasi</a></p>
                        </div>
