                ...
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('monitoring/upload_bukti_pembayaran')?>" class="more-39291">Upload Bukti pembayaran</a></p>
                        ...
                        <div class="col-lg-6 col-md-6 mb-5">
                            <div class="post-entry-1 h-100">
                                <div class="row align-items-stretch">
                                    ...
                                    <?php
                                        if(isset($monitoring_unit['pembayaran'])){
                                            foreach ($monitoring_unit['pembayaran'] as $value) {
                                                ?>
                                                    <div class="col-lg-6 col-md-6 mb-5">
                                                        <div class="post-entry-1 h-100">
                                                            <a href="#">
                                                                <img src="<?=base_url('images/bukti_pembayaran/'.$value['bon'])?>" alt="Image"
                                                                class="img-fluid">
                                                            </a>
                                                            <div class="post-entry-1-contents">
