                ...
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('developer/data_proyek/tambah_data_proyek')?>" class="more-39291">Tambah Data Proyek</a></p>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <table class="proyek">
                                    ...
                                    <?php 
                                        ...
                                        foreach ($proyek as $proyek): 
                                            ...
                                            ?>
                                                <td>
                                                    <a href="<?=site_url('developer/data_proyek/'.$proyek->status."/".$proyek->id_data_proyek)?>">Lihat</a>
                                                    /
                                                    <a href="<?=site_url('developer/data_proyek/update/'.$proyek->id_data_proyek)?>">Edit</a>
                                                    /
                                                    <a href="#!" onclick="deletekonfirm('<?=site_url('developer/data_proyek/hapus_proyek/'.$proyek->id_data_proyek)?>')">Hapus</a>
                                                </td>
                                            <?php
                                            echo "</tr>";
                                            $i++;
