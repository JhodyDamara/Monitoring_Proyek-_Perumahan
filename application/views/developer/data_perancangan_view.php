                ...
                <div class="container">
                    <div class="row  mb-5"> 
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('developer/data_perancangan_proyek/tambah_data_perancangan')?>" class="more-39291">Tambah Rancangan Proyek</a></p>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <table class="proyek">
                                    ...
                                    <?php
                                        ...
                                        foreach ($data_perancangan_proyek[0] as $key => $value){
                                            ...
                                            echo "<td>";
                                                ?>
                                                    <a href="<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/'.$value->id_data_proyek)?>">Lihat</a>
                                                    /
                                                    <a href="<?=site_url('developer/data_perancangan_proyek/edit_data_perancangan/'.$value->id_data_proyek)?>">Edit</a>
                                                    /
                                                    <a href='#!' onclick="deletekonfirm('<?=site_url('developer/data_perancangan_proyek/hapus_data_perancangan/'.$value->id_data_proyek)?>')">Hapus</a>
                                                <?php
                                            echo "</td>";
                                            echo "</tr>";
                                        }
