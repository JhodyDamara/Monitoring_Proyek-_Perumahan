                ...
                <div class="container">
                    <div class="row  mb-5">
                        <div class="col-md-7">
                            ...
                            <p class="my-5"><a href="<?=site_url('developer/data_proyek/perancangan/pembangunan/tambah_pembangunan')?>" class="more-39291">Tambah Pembangunan</a></p>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        foreach ($rancanganpembangunan as $rancanganpembangunan):
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?=site_url('developer/data_proyek/perancangan/pembangunan/edit_pembangunan/'.$rancanganpembangunan->id_target_pembangunan)?>">Edit</a>
                                                        /
                                                        <a href="#!" onclick="deletekonfirm('<?=site_url('developer/data_proyek/perancangan/pembangunan/hapus_pembangunan/'.$rancanganpembangunan->id_target_pembangunan)?>')" href="">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            $no++;
