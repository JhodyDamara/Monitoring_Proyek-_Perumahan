            ...
            <div class="site-section">
                <div class="container">
                    <div class="row mb-5 align-items-center">
                        <div class="col-md-7">
                            <h1 class="heading-39291">Edit Evaluasi <br> Proyek</h1>
                        </div>
                            ...
                            <div class="col-md-7">
                                <div class="text">
                                    <form action="" method="post">
                                        <?php
                                            foreach ($data_evaluasi as $value) {
                                                ?>
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <label for="masalah">Masalah</label>
                                                            <input type="text" name="masalah" id="masalah" class="form-control" value="<?=$value->problem?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <label for="masukkan">Masukkan</label>
                                                            <textarea name="masukkan" id="masukkan" cols="30" rows="10" class="form-control"><?=$value->masukkan?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
