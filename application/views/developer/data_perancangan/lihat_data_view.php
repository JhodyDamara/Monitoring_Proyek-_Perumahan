                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-12">
                            <blockquote class="testimonial-1">
                                ...
                                <p><a href="<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/start_proyek')?>" class="more-39291">Start Proyek</a></p>
                        ...
                        <?php
                            ...
                            foreach ($data_perancangan_lihat['blok'] as $key => $value){
                                ...
                                foreach ($data_perancangan_lihat['unit'][$key] as $key1 => $value1) {
                                    ...
                                    echo "<p><a href='".site_url('developer/data_perancangan_proyek/lihat_data_perancangan/tambah_target_pekerjaan/'.$key1)."' class='more-39291'>Tambah Target Pekerjaan</a></p>";
                                    ...
                                    foreach ($data_perancangan_lihat['pekerjaan'][$key1] as $value1) {
                                        ...
                                        echo "<td>";
                                            ?>
                                                <a href="<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/edit_target_pekerjaan/'.$value1['id_target_pembangunan'])?>">Edit</a>
                                                /
                                                <a href='#!' onclick="deletekonfirm('<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/hapus_target_pekerjaan/'.$value1['id_target_pembangunan'])?>')">Hapus</a>
                                            <?php
                                        echo "</td>";
                                        echo "</tr>";
                                        $no++;
                                    ...
                                    echo "<p><a href='".site_url('developer/data_perancangan_proyek/lihat_data_perancangan/tambah_rancangan_anggaran/'.$key1)."' class='more-39291'>Tambah Rancangan Anggaran</a></p>";
                                    echo "<table class='proyek'>";
                                    echo "<tr>";
                                    echo "<th>No</th>";
                                    ...
                                    foreach ($data_perancangan_lihat['anggaran'][$key1] as $value1) {
                                        ...
                                        echo "<td>";
                                            ?>
                                                <a href="<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/edit_rancangan_anggaran/'.$value1['id_target_keuangan'])?>">Edit</a>
                                                /
                                                <a href='#!' onclick="deletekonfirm('<?=site_url('developer/data_perancangan_proyek/lihat_data_perancangan/hapus_rancangan_anggaran/'.$value1['id_target_keuangan'])?>')">Hapus</a>
                                            <?php
                                        echo "</td>";
                                        echo "</tr>";
                                        $no++;
