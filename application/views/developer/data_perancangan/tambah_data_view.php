                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <select name="jenis" id="jenis" class="form-control" onchange="perumahan('<?=site_url('developer/jumlahblok')?>')">
                                        ...
                                        <div id="formblok" class="form-group row">
                                            <div class="col-md-12">
                                                <label for="jumlah">Jumlah Blok</label>
                                                <input type="number" name="jumlah" id="jumlah" class="form-control" onkeyup="jumlahblok('<?=site_url('developer/jumlahblok')?>')" autocomplete="off">
                                            </div>
                                        </div>
                                        <div id="form" class="form-group row"></div>
                                        <div class="form-group row">
